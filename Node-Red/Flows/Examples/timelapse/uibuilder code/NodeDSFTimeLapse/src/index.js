...
new Vue({
    ...
    methods: {
        tlsave: function(event) {
            //console.log('Button Pressed. Event Data: ', event)
            var topic = this.msgRecvd.topic || 'uibuilder/vue'
            uibuilder.send( {
                'topic': topic,
                'payload': {
                    'timelapse.webCamURL': this.camURL,
                    'timelapse.imgPath': this.imgPath,
                    'timelapse.vidPath': this.vidPath,
                    'timelapse.ffmpegPath': this.ffmpegPath
                }
            } )
    ...
    mounted: function(){
        ...
        uibuilder.onChange('msg', function(msg){
            ...
            app.camURL = msg.payload.timelapse.webCamURL
            app.imgPath = msg.payload.timelapse.imgPath
            app.vidPath = msg.payload.timelapse.vidPath
            app.ffmpegPath = msg.payload.timelapse.ffmpegPath

*This project has not been released. Node-Red nodes will be published to the standard Node-Red palette manager, and the plugin will be made available through standard github release management.
